...
class PlanningHistoryService(HistoryService):
    ...
    def on_item_updated(self, updates: dict[str, Any], original: dict[str, Any], operation: str | None = None):
    ...
    def _get_coverage_diff(self, updates, original):
        ...
        cov_plan_diff = self._changes(original.get("planning"), updates.get("planning"))
