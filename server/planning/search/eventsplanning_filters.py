...
SCHEDULE_FREQUENCY: ScheduleFrequency = ScheduleFrequency("hourly", "daily", "weekly", "monthly")
...
WEEK_DAY: WeekDay = WeekDay("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
...
def list_strings():
    return {"type": "list", "nullable": True}
...
def cv(qcode_type="string", extra_fields=None):
    schema = {"qcode": {"type": qcode_type}, "name": {"type": "string"}}
    ...
    "schedules": {
        ...
        "schema": {
            ...
            "schema": {
                ...
                "week_days": {"type": "list", "allowed": tuple(WEEK_DAY)},
            },
        },
    },
}
...
class EventPlanningFiltersService(Service):
    ...
    def _push_notification(self, _id, event_name):
        ...
        push_notification(event_name, item=str(_id), user=str(get_user_id()))
    ...
    def set_schedule(self, updates):
        ...
        for schedule in updates["schedules"]:
            ...
            if frequency == "hourly":
                ...
                schedule.update({"frequency": "monthly", "hour": hour, "day": day, "week_days": []})
