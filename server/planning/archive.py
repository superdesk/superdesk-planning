...
async def create_item_from_template(doc, extra_fields_to_override=None, translations=None):
    ...
    item_id = (await archive_service.post_async([deepcopy(doc)]))[0]
    ...
    if len(updates):
        await archive_service.patch_async(item_id, updates)
