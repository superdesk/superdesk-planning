...
class ExportScheduledFiltersTestCase(TestCase):
    ...
    def test_send_report_hourly(self):
        # Test every hour
        self._test(
            report={"frequency": "hourly", "hour": -1},
            start="2018-06-30T00",
            end="2018-06-30T23",
    ...
    def test_send_report_hour_of_the_day(self):
        # Test exact hour
        self._test(
            report={"frequency": "daily", "hour": 10},
            start="2018-06-30T00",
            end="2018-06-30T23",
    ...
    def test_send_report_daily(self):
        # Every day at 8am
        self._test(
            report={"frequency": "daily", "hour": 8},
            start="2018-06-01T00",
            end="2018-06-30T23",
            expected_hits=[to_local(f"2018-06-{day}T08") for day in range(1, 31)],
        )
    ...
    def test_send_report_monthly(self):
        self._test(
            report={"frequency": "monthly", "hour": 0, "day": 1},
            start="2018-01-01T00",
            end="2018-12-31T23",
            expected_hits=[
