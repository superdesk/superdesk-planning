    ...
    def forwards(self, mongodb_collection, mongodb_database):
        for search_filter in mongodb_collection.find({}):
            ...
            mongodb_collection.update(
                {"_id": filter_id},
                {
                    "$set": {"item_type": "combined", "params": params},
                    "$unset": {"agendas": "", "calendars": "", "places": ""},
                },
            )
    ...
    def backwards(self, mongodb_collection, mongodb_database):
        for search_filter in mongodb_collection.find({}):
            ...
            if len(params.get("agendas") or []):
                updates["agendas"] = {"_id": agenda_id for agenda_id in params["agendas"]}
            ...
            mongodb_collection.update(
                {"_id": filter_id},
                {"$set": updates, "$unset": {"item_type": "", "params": ""}},
            )
