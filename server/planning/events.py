...
class EventsService(superdesk.Service):
    ...
    def on_create(self, docs):
        ...
        for event in docs:
            ...
            if self.find_one(req=None, unique_name=event['unique_name']):
                raise SuperdeskApiError.badRequestError(
                    # error.data._issues.unique_name.unique
                    payload={'unique_name': {'unique': 1}},
                    message='An event already exists with the unique_name %s' % event['unique_name']
                )
