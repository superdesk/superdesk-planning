Feature: Events Reschedule
    ...
    Scenario: Increase number of occurrences
        ...
        [{
            "name": "Friday Club",
            "dates": {
                "start": "2053-11-20T12:00:00.000Z",
                "end": "2053-11-20T14:00:00.000Z",
                "tz": "Australia/Sydney",
                "recurring_rule": {
                    "frequency": "WEEKLY",
                    "interval": 1,
        ...
        {"_items": [
            {
                "name": "Friday Club",
                "dates": {
                    "start": "2053-11-21T12:00:00+0000",
                    "end": "2053-11-21T14:00:00+0000",
                    "tz": "Australia/Sydney",
                    "recurring_rule": {
                        "frequency": "WEEKLY",
                        "interval": 1,
                ...
                "name": "Friday Club",
                "dates": {
                    "start": "2053-11-28T12:00:00+0000",
                    "end": "2053-11-28T14:00:00+0000",
                    "tz": "Australia/Sydney",
                    "recurring_rule": {
                        "frequency": "WEEKLY",
                        "interval": 1,
                ...
                "name": "Friday Club",
                "dates": {
                    "start": "2053-12-05T12:00:00+0000",
                    "end": "2053-12-05T14:00:00+0000",
                    "tz": "Australia/Sydney",
                    "recurring_rule": {
                        "frequency": "WEEKLY",
                        "interval": 1,
        ...
        """
        {
            ...
            "dates": {
                "start": "2053-11-21T12:00:00.000Z",
                "end": "2053-11-21T14:00:00.000Z",
                "tz": "Australia/Sydney",
                "recurring_rule": {
                    "frequency": "WEEKLY",
                    "interval": 1,
        ...
        {"_items": [
            {
                ...
                "name": "Friday Club",
                "dates": {
                    "start": "2053-12-12T12:00:00+0000",
                    "end": "2053-12-12T14:00:00+0000",
                    "tz": "Australia/Sydney",
                    "recurring_rule": {
                        "frequency": "WEEKLY",
                        "interval": 1,
        ...
        [
            {
                ...
                "coverages": [{
                    "planning": {
                        ...
                        "headline": "test headline",
                        "slugline": "test slugline",
                        "scheduled": "2053-11-21T14:00:00.000Z",
                        "g2_content_type": "text"
                    },
                    "news_coverage_status": {"qcode": "ncostat:int"},
                    "workflow_status" : "draft"
                }],
                "planning_date": "2053-01-02"
            },
            {
                "guid": "plan2",
                "slugline": "Weekly Meetings",
        ...
        {"_items": [
            {
                ...
                "coverages": [{
                    ...
                    "planning": {
                        ...
                        "headline": "test headline",
                        "slugline": "test slugline",
                        "scheduled": "2053-11-21T14:00:00+0000",
                        "g2_content_type": "text"
                    },
                    "news_coverage_status": { "qcode": "ncostat:int" }
                }]
