...
import {Input, SelectMetaTerms, TreeSelect, ToggleInput, Popup} from '../../common';
...
export class PlanningEditor extends Editor {
    ...
    constructor() {
        ...
        this.fields = {
            ...
            urgency: new TreeSelect(getParent, '[data-test-id=field-urgency]', false),
            flags: {
    ...
    get addCoverageButton() {
        return this.coveragesContainer.find('[data-test-id="create-button"]');
    }
