...
export default class Popup extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.dom.portal.defaultNode) {
    ...
    handleClickOutside(event) {
        const root = this.dom.portal.defaultNode;

        if (!root || root.contains(event.target) || !document.contains(event.target)) {
            return;
        }
    ...
    setPortalNodes(node) {
        ...
        if (this.dom.portal) {
            this.dom.root = this.dom.portal.defaultNode;
    ...
    render() {
        return (
            <div ref={this.setParentNode}>
                <Portal ref={this.setPortalNodes}>
                    {this.props.children}
                </Portal>
            </div>
        );
...
PropTypes.defaultProps = {workspaceId: 'main-container'};
