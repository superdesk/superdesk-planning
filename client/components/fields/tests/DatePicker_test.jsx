...
describe('<DatePicker />', () => {
    ...
    it('selecting date closes the popup', () => {
        ...
        const rows = wrapper.find('.datepickerPopup__core').find('table')
            .find('tbody')
            .find('tr');
        const targetDate = rows.at(1).find('td')
            .at(5);

        expect(targetDate.at(0).text()).toBe('10');
        targetDate.at(0).childAt(0)
            .simulate('click');
        expect(wrapper.find('.datepickerPopup').length).toBe(0);
    });
    ...
    it('month can be manually selected', () => {
        ...
        const rows = wrapper.find('.datepickerPopup__core').find('table')
            .find('tbody')
            .find('tr');
        const targetMon = rows.at(1).find('td')
            .at(1);
    ...
    it('year can be manually selected', () => {
        ...
        const rows = wrapper.find('.datepickerPopup__core').find('table')
            .find('tbody')
            .find('tr');
        const targetYr = rows.at(1).find('td')
            .at(2);
