...
const mapStateToProps = (state: IPlanningAppState) => ({
    ...
    associatedEvent: selectors.events.planningEditAssociatedEvent(state), // TODO: go over usages and remove
...
const mapStateToPropsModal = (state) => ({
    ...
    associatedEvent: selectors.events.planningEditAssociatedEventModal(state), // TODO: go over usages and remove
