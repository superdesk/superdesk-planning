...
describe('<WorkqueueList />', () => {
    ...
    it('renders workqueue list', () => {
        ...
        expect(wrapper.find('.title').first()
            .text()).toBe('e1 slugline');
        expect(wrapper.find('.title').at(1)
            .text()).toBe('Some Plan 1');
        expect(wrapper.find('.title').at(2)
            .text()).toBe('Some Plan 2');
    });
