...
const defaultPlanningValues = (currentAgenda, defaultPlaceList) => {
    const {contentProfiles} = planningApi;
    const defaultValues = contentProfiles.getDefaultValues(contentProfiles.get('planning'));
    const newPlanning = Object.assign(
        {
            type: ITEM_TYPE.PLANNING,
            planning_date: moment(),
...
const defaultCoverageValues = (
    ...
    const newCoverage: DeepPartial<IPlanningCoverageItem> = {
