...
import {IAttachmentsFieldConfig, IAttachmentsFieldUserPreferences, IAttachmentsValueOperational, IAttachmentsValueStorage} from './interfaces';
import {superdesk} from '../../superdesk';

const {gettext} = superdesk.localization;

export function getAttachmentsField()
